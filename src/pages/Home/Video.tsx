...
const Video = () => {
	...
	return (
		<section className='h-[80svh] bg-[url("../../../src/assets/images/Deluxe.jpg")] w-full bg-cover bg-center bg-fixed mb-16 flex items-center justify-center brightness-75 mt-5'>
			<div>
				<PlayCircleIcon
					width={120}
					height={150}
