...
const Discover = () => {
	return (
		<section className=' px-20 flex flex-col items-center py-[4rem]'>
			...
			/>
			<div className='h-[400px]  flex items-center justify-center  my-8 '>
				<div className='grid w-full h-full grid-cols-4 gap-8 px-10 grid-cover'>
			...
			<div className='mt-3'>
				Check more <Button className='uppercase rounded-none'>Places</Button>{' '}
				now
			</div>
		</section>
	);
