	...
	return (
		<>
			<header className='flex flex-col w-full gap-2 bg-white max-w-[1268px] mx-auto'>
				<div className='flex items-center justify-between px-28 py-2 text-[#908A99] text-sm font-semibold'>
			...
			<nav className='sticky top-0 z-20 flex items-center px-28 py-4 mx-auto bg-white shadow-sm max-w-[1268px]'>
				<Logo />
