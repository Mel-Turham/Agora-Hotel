...
const Navbar = () => {
	return (
		<>
			<Container>
				<header className='flex flex-col w-full gap-2 bg-white max-w-[1268px] mx-auto'>
					<div className='flex items-center justify-between  py-2 text-[#908A99] text-sm font-semibold'>
			...
			<hr />
			<Container className='sticky top-0 z-20 w-full bg-white'>
				<nav className='flex items-center py-4 mx-auto shadow-sm '>
					<Logo />
